...
/**
 * This class adds an empty page to a PDF document.
 * 
 * @author Rafael Wampfler
 * @author $Author$
 * @version $Revision$
 */
public class AppendEmptyPageListener implements Listener
{

  private static final Logger LOGGER = Logger.getLogger(AppendEmptyPageListener.class);
   ...
   *          Parent shell
   */
  public AppendEmptyPageListener(final MainGUI maingui)
  {
  ...
  public void handleEvent(final Event event)
  {
    ...
    maingui.switchMode(GuiMode.appendEmptyPage);
    try
    {
      PdfAttacher attacher = new PdfAttacher();
      byte[] output = attacher.attachEmptyPage(new PdfReader(maingui.getInputFile()));
